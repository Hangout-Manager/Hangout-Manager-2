...
ActiveRecord::Schema.define(version: 2020_09_25_101929) do
  ...
  create_table "covid_questions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.integer "q1"
    t.integer "q2"
    t.integer "q3"
  ...
  create_table "hangouts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.float "agon"
    t.float "alea"
    t.float "mimicry"
  ...
  create_table "long_trends", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.float "agon"
    t.float "alea"
    t.float "mimicry"
    t.float "ilinx"
  ...
  create_table "risks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "value"
  ...
  add_foreign_key "participations", "posts"
